...
<head>
    ...
    <!-- SEO Meta Tags -->
    <title>Website & Development Pricing Plans | GrowBoostly</title>
    <meta name="description" content="Explore GrowBoostly's transparent Website and Development pricing plans. Get high-converting landing pages, corporate websites, custom web apps, and monthly maintenance." />
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Website & Development Pricing Plans | GrowBoostly">
    <meta property="og:description" content="High-performance custom website designs, landing pages, and web apps built for leads, speed, and conversion. View our pricing plans.">
    <meta property="og:url" content="https://www.growboostly.com/pricing/website-development-pricing">
            ...
            <div class="container">
                <div class="row align-items-center g-5">
                    ...
                    <div class="col-lg-6">
                            ...
                            <a href="../pricing.php" class="pricing-hero-back" aria-label="Back to pricing" title="Back to Pricing">
                                <i class="bi bi-arrow-left"></i>
                            </a>
                            <ul class="breadcrumb-list">
                                <li><a href="../index.php">Home</a> <i class="bi bi-chevron-right"></i></li>
                                <li><a href="../pricing.php">Pricing</a> <i class="bi bi-chevron-right"></i></li>
                            ...
                            <div class="hero-actions">
                                <a href="#plans" class="btn-primary">Explore Pricing Plans</a>
