    ...
    <header class="header-area style-4">
        <div class="container-fluid d-flex flex-nowrap align-items-center justify-content-between">
            <div class="company-logo">
                <a href="https://www.growboostly.com/" class="logo-dark"><img alt="image" class="img-fluid" src="../assets/img/grow-boostly.png"></a>
                <a href="https://www.grosboostly.com/" class="logo-light"><img alt="image" class="img-fluid" src="../assets/img/grow-boostly.png"></a>
            </div>
            <div class="menu-wrap">
                <div class="main-menu">
                    <div class="mobile-logo-area d-lg-none d-flex align-items-center justify-content-between">
                        <a href="https://www.growboostly.com/" class="mobile-logo-wrap">
                            <img alt="image" class="img-fluid light" src="../assets/img/grow-boostly.png">
                            <img alt="image" class="img-fluid dark" src="../assets/img/grow-boostly.png">
                        </a>
                    ...
                    <ul class="menu-list">
                        ...
                        <li class="menu-item-has-children position-inherit">
                            <a href="" class="drop-down">Marketing
                            </a>
                                            ...
                                            <ul class="menu-row">
                                                ...
                                                <li class="menu-single-item">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="">Conversation Optimization</a></li>
                                                        <li><a href="">App Store Optimization</a></li>
                                                        <li><a href="">Social Media Marketing</a></li>
                                                        <li><a href="">YouTube Marketing</a></li>
                                                        <li><a href="">ORM/Reputation Management</a></li>
                                        ...
                                        <div class="col-lg-4">
                                            <div class="solution-menu-banner">
                                                <div class="banner-content">
                                                    ...
                                                    <a href="https://www.growboostly.com/contact.php" class="primary-btn1">
                                                        <span>Let’s Talk
                                                            <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round" />
                                                            </svg>
                        ...
                        <li class="menu-item-has-children position-inherit">
                            <a href="" class="drop-down">Development
                            </a>
                            <i class="bi bi-plus dropdown-icon"></i>
                            <div class="mega-menu2">
                                <div class="container">
                                            ...
                                            <ul class="menu-row">
                                                ...
                                                <li class="menu-single-item">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <li><a href="">Education App</a></li>
                                                        <li><a href="">Sports & Fitnes App</a></li>
                        ...
                        <li class="menu-item-has-children">
                            <a href="" class="drop-down">Branding</a>
                            <i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                <li><a alt="Logo Design">Logo Design</a></li>
                                <li><a alt="Packaging Design">Packaging Design</a></li>
                                <li><a alt="Brand Guidelines">Brand Guidelines</a></li>
                                <li><a alt="Social Media Kits">Social Media Kits</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="" class="drop-down">Influencers</a>
                            <i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                ...
                                <li><a alt="">Beauty</a></li>
                                <li><a alt="Fashion/Lifestyle">Fashion/Lifestyle</a></li>
                                <li><a alt="Fitness">Fitness</a></li>
                                <li><a alt="Food">Food</a></li>
                                <li><a alt="Gaming">Gaming</a></li>
                                <li><a alt="Technology">Technology</a></li>
                                <li><a alt="Travel">Travel</a></li>
                            </ul>
                        </li>
                        <li class="menu-item-has-children">
                            <a href="" class="drop-down">Hire</a>
                            <i class="bi bi-plus dropdown-icon"></i>
                            <ul class="sub-menu">
                                ...
                                <li><a href="">PHP / Laravel Developers</a></li>
                                <li><a href="">Web Developers</a></li>
                                <li><a href="">Fintech Software Developers</a></li>
                    ...
                    <div class="btn-and-contact-area d-lg-none d-block">
                        <a href="https://www.growboostly.com/contact.php" class="primary-btn4">
                            <span class="icon">
                                <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                    <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round" />
                                </svg>
                ...
                <div class="nav-right">
                    <div class="contact-area d-lg-flex d-none">
                        ...
                        <div class="content">
                            ...
                            <h6><a href="tel:+919919020887">+91 9919 020 887 </a></h6>
                        </div>
                    </div>
                    <a href="https://www.growboostly.com/contact.php" class="primary-btn4 d-lg-flex d-none">
                        <span class="icon">
                            <svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg">
                                <path d="M1 9L9 1M9 1C7.22222 1.33333 3.33333 2 1 1M9 1C8.66667 2.66667 8 6.33333 9 9" stroke-width="1.5" stroke-linecap="round" />
                            </svg>
