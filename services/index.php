...
$service_categories = [
    'leadgen' => [
        ...
        'services' => [
            ['b2b-lead-generation.php', 'B2B Lead Generation', 'Outbound and inbound programmes for decision-makers and enterprise buyers.'],
            ['b2c-lead-generation.php', 'B2C Lead Generation', 'Consumer acquisition across paid social, search, and conversion funnels.'],
            ['ai-based-lead-targeting.php', 'AI-Based Lead Targeting', 'Smarter audience segmentation and lookalike modelling for lower CPA.'],
            ['landing-page-creation.php', 'Landing Page Creation', 'High-converting pages built for campaigns, offers, and lead capture.'],
            ['sales-funnel-development.php', 'Sales Funnel Development', 'End-to-end funnel architecture from awareness to closed deals.'],
            ['lead-nurturing.php', 'Lead Nurturing', 'Email and automation sequences that warm leads until they are sales-ready.'],
            ['crm-integration.php', 'CRM Integration', 'Connect ads, forms, and nurture flows to HubSpot, Zoho, Salesforce, and more.'],
        ],
    ],
    'performance' => [
        ...
        'services' => [
            ['google-ads.php', 'Google Ads (PPC)', 'Search, Display, and Performance Max campaigns with rigorous tracking.'],
            ['facebook-instagram-ads.php', 'Facebook & Instagram Ads', 'Meta campaigns for awareness, leads, and eCommerce conversions.'],
            ['linkedin-ads.php', 'LinkedIn Ads (B2B)', 'Account-based and lead-gen ads for professional audiences.'],
            ['search-engine-marketing.php', 'Search Engine Marketing', 'Integrated paid search strategy across Google and Bing.'],
            ['retargeting-remarketing.php', 'Retargeting & Remarketing', 'Win back visitors and cart abandoners with sequenced ads.'],
            ['conversion-rate-optimisation.php', 'Conversion Rate Optimisation', 'UX, messaging, and testing to lift form fills and purchases.'],
            ['ab-testing.php', 'A/B Testing & Optimisation', 'Structured experiments on pages, ads, and offers.'],
        ],
    ],
    'digital' => [
        ...
        'services' => [
            ['seo.php', 'Search Engine Optimisation', 'Technical, on-page, and authority SEO for sustainable rankings.'],
            ['ai-powered-seo.php', 'AI-Powered SEO', 'AI-assisted content, clustering, and optimisation at scale.'],
            ['social-media-marketing.php', 'Social Media Marketing', 'Organic and paid social strategies for brand and demand.'],
            ['app-store-optimisation.php', 'App Store Optimisation', 'Keywords, creatives, and listings to grow organic app installs.'],
            ['content-marketing.php', 'Content Marketing', 'Blogs, video, and thought leadership that builds authority.'],
            ['email-marketing-automation.php', 'Email Marketing Automation', 'Lifecycle flows, newsletters, and behaviour-triggered email.'],
            ['online-reputation-management.php', 'Online Reputation Management', 'Reviews, SERP reputation, and AI brand monitoring.'],
            ['youtube-marketing.php', 'YouTube Marketing', 'Channel growth, SEO, and video campaigns on YouTube.'],
        ],
    ],
    'influencer' => [
        ...
        'services' => [
            ['influencer-marketing.php', 'Influencer Research & Strategy', 'Creator discovery, briefs, and campaign planning.'],
            ['campaign-management.php', 'Campaign Management', 'End-to-end execution across Meta, Google, and LinkedIn.'],
            ['instagram-influencer-marketing.php', 'Instagram Influencer Marketing', 'Reels, Stories, and collabs with matched creators.'],
            ['youtube-influencer-marketing.php', 'YouTube Influencer Marketing', 'Sponsored integrations and dedicated review videos.'],
            ['creator-collaborations.php', 'Creator Collaborations', 'UGC, brand deals, and long-term creator partnerships.'],
            ['performance-tracking.php', 'Performance Tracking', 'Creator-wise ROI, UTMs, and lead attribution dashboards.'],
        ],
    ],
    'web' => [
        ...
        'services' => [
            ['business-website-development.php', 'Business Website Development', 'Corporate and service sites built for trust and leads.'],
            ['ecommerce-development.php', 'eCommerce Development', 'Online stores with catalog, checkout, and conversion UX.'],
            ['landing-page-development.php', 'Landing Page Development', 'Campaign-specific pages engineered for conversion.'],
            ['website-redesign.php', 'Website Redesign', 'Modernise UX, speed, and messaging without losing SEO equity.'],
            ['maintenance-support.php', 'Maintenance & Support', 'Updates, security, hosting support, and ongoing fixes.'],
        ],
    ],
    'app' => [
        ...
        'services' => [
            ['android-app-development.php', 'Android App Development', 'Kotlin/Java apps for Google Play with performance focus.'],
            ['ios-app-development.php', 'iOS App Development', 'Swift-based apps optimised for the App Store.'],
            ['cross-platform-apps.php', 'Cross-Platform Apps', 'Shared codebase delivery for iOS and Android.'],
            ['ui-ux-design.php', 'UI/UX Design', 'Research, wireframes, and interfaces that improve retention.'],
        ],
    ],
    'branding' => [
        ...
        'services' => [
            ['logo-design.php', 'Logo Design', 'Memorable marks aligned with your positioning.'],
            ['brand-identity-design.php', 'Brand Identity Design', 'Visual systems — colour, type, and brand guidelines.'],
            ['brand-strategy.php', 'Brand Strategy', 'Positioning, messaging, and go-to-market narrative.'],
            ['brand-positioning.php', 'Brand Positioning', 'Differentiation frameworks for crowded categories.'],
            ['social-media-creatives.php', 'Social Media Creatives', 'Ad and organic creative assets for social channels.'],
            ['packaging-design.php', 'Packaging Design', 'Product packaging that sells on shelf and online.'],
            ['rebranding.php', 'Rebranding', 'Full refresh of identity, voice, and customer touchpoints.'],
        ],
    ],
    'developers' => [
        ...
        'services' => [
            ['full-stack-developers.php', 'Full-Stack Developers', 'End-to-end web product engineers for fast delivery.'],
            ['backend-developers.php', 'Backend Developers', 'APIs, databases, and server architecture.'],
            ['android-developers.php', 'Android Developers', 'Dedicated Android engineers for ongoing product work.'],
            ['nodejs-developers.php', 'Node.js Developers', 'Scalable JavaScript backends and real-time systems.'],
            ['php-laravel-developers.php', 'PHP / Laravel Developers', 'Robust Laravel applications and legacy modernisation.'],
            ['web-developers.php', 'Web Developers', 'Front-end and CMS implementation specialists.'],
            ['fintech-software-developers.php', 'Fintech Software Developers', 'Secure, compliant builds for finance products.'],
            ['dedicated-developer.php', 'Dedicated Developers', 'Flexible monthly capacity on your stack and roadmap.'],
            ['swift-developer.php', 'Swift Developers', 'iOS specialists for native app features and releases.'],
        ],
    ],
];
...
<head>
    ...
    <title>All Services | Lead Generation, Marketing, Development & Branding – Grow Boostly</title>
    <meta name="description" content="Explore <?php echo (int) $total_services; ?>+ growth services from Grow Boostly — lead generation, performance marketing, SEO, influencer campaigns, web & app development, branding, and dedicated developers.">
    <meta name="robots" content="index, follow">
    <link rel="canonical" href="https://growboostly.com/services/">
            ...
            <div class="col-lg-6">
                <div class="svc-hero-content">
                    ...
                    <div class="svc-hero-actions">
                        <a href="../contact.php?ref=services-hero" class="svc-btn svc-btn-primary">Book Free Consultation</a>
                        <a href="../pricing.php" class="svc-btn svc-btn-outline">View Growth Plans</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="svc-hero-visual">
                    ...
                    <div class="svc-hero-image-wrapper">
                        <img src="../assets/img/services_hero_growth_ecosystem.png" alt="Grow Boostly Growth Services Ecosystem" class="img-fluid">
                    </div>
                </div>
            </div>
        </div>
...
<section class="svc-main">
    <div class="container">
        <div class="svc-empty" id="svcEmpty">
            ...
            <p style="margin:0;color:var(--svc-muted);">Try another term or <a href="../contact.php?ref=services-search">tell us what you need</a>.</p>
        </div>
        ...
        <div class="svc-category" id="cat-<?php echo htmlspecialchars($cat_id, ENT_QUOTES, 'UTF-8'); ?>" data-category="<?php echo htmlspecialchars($cat_id, ENT_QUOTES, 'UTF-8'); ?>">
            ...
            <div class="svc-grid">
                <?php foreach ($cat['services'] as $svc) :
                    $href = htmlspecialchars($svc[0], ENT_QUOTES, 'UTF-8');
        ...
        <div class="svc-cta">
            ...
            <div class="svc-hero-actions">
                <a href="../contact.php?ref=services-cta" class="svc-btn svc-btn-primary">Get Free Growth Plan</a>
                <a href="../faq.php" class="svc-btn svc-btn-outline" style="background:rgba(255,255,255,0.1);border-color:rgba(255,255,255,0.2);color:#fff;">Read FAQs</a>
            </div>
        </div>
    </div>
</section>
